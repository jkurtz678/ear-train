...
<template>
  ...
  <div class="page">
    <div class="card">
      ...
      <!-- LAYOUT 1: Centered question with side-by-side audio indicator -->
      <div class="question-section">
        <div class="question-row">
          <div class="question-main">
            <div class="question-label">Question</div>
            <div class="question-number">{{ currentQuestionNumber }}/{{ numberOfQuestions }}</div>
          </div>
...
/* LAYOUT 1: Centered with side-by-side audio */
.question-section {
  display: flex;
  justify-content: center;
  padding: 16px 0;
